...
import database.base.SQLiteDALbase;
...
public class SQLiteDALUser extends SQLiteDALbase{
	...
	public List<ModelUser> GetUser(String pCoundition){
		String _SqlText = "Select * From User Where 1=1 " + pCoundition;
...
public ContentValues CreateParms(ModelUser p_Info){
	...
	_ContentValues.put("CreateDate",DateTools.getFormatDateTime(p_Info.getCreateData(),"yyyy-MM-dd HH:"));
